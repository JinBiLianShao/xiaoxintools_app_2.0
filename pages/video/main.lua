...
functions["解析2"]=function()
  local url=获取网址()
  加载网页("https://www.yemu.xyz/?url=" .. url)
end

functions["解析1"]=function()
  local url=获取网址()
  加载网页("https://svip.bljiex.cc/?v=" .. url)
end

functions["解析3"]=function()
  local url=获取网址()
  加载网页("https://im1907.top/?jx=" .. url)
end

functions["横屏"]=function()
   activity.setRequestedOrientation(0)
end

functions["竖屏"]=function()
